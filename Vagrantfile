Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell,
    :inline => "sudo apt-get update && sudo apt-get -y install build-essential git python-software-properties &&  sudo apt-add-repository -y ppa:brightbox/ruby-ng && sudo apt-get update && sudo apt-get -y install ruby2.0 ruby2.0-dev libicu48 && sudo gem install bundler && cd /home/vagrant/bitcoin.org && bundle install && cd /home/vagrant/bitcoin.org/_site && bundle exec jekyll build"
